...
//we could change this into a hash if we end up having a large opcode 
var opcodeToName = Object.keys(opcodes).reduce((accum, codeName) => {
  accum[opcodes[codeName]] = codeName.toLowerCase().replace(/_/g, "-");
  return accum;
}, []);

var instructions = {
  opcodes: opcodes,
  opcodeToName: opcodeToName
};
